...
void loop(void)
{
  ...
  CircuitPlayground.setPixelColor(0, HEX);
  CircuitPlayground.setPixelColor(1, HEX);
  CircuitPlayground.setPixelColor(2, HEX);
  CircuitPlayground.setPixelColor(3, HEX);
  CircuitPlayground.setPixelColor(4, HEX);
  CircuitPlayground.setPixelColor(5, HEX);
  CircuitPlayground.setPixelColor(6, HEX);
  CircuitPlayground.setPixelColor(7, HEX);
  CircuitPlayground.setPixelColor(8, HEX);
  CircuitPlayground.setPixelColor(9, HEX);
  strip.show();
